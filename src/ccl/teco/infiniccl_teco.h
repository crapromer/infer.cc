...
infinicclStatus_t infinicclSdaaCommInitAll(
    infinicclComm_t *comms, unsigned int numDevices,
    unsigned int const *deviceIDs) IMPL_WITH_TECO infinicclStatus_t
    infinicclSdaaCommDestroy(infinicclComm_t comm)
        IMPL_WITH_TECO infinicclStatus_t
    infinicclSdaaAllReduceSum(infinicclComm_t comm, void *sendbuf,
